let data = [
    {value:'周董的歌真好！', time:5, color:'red', speed:1, fontSize:22},
    {value:'下一首！', time:10, color:'yellow', speed:1, fontSize:22},
    {value:'再来一遍', time:12, color:'green', speed:1, fontSize:22},
    {value:'周董的歌真好！', time:5, color:'red', speed:1, fontSize:22},
    {value:'下一首！', time:10, color:'yellow', speed:1, fontSize:22},
    {value:'再来一遍', time:12, color:'green', speed:1, fontSize:22}
]
